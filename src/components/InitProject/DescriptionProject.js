  ...
  return (
    <div className="description-title-project">
      <p>      <p>
        ...
        so it is recommended to open it on a widescreen monitor for proper display.<br></br>
        In general, this is a template from a telegram channel that was proposed in a practical assignment.
